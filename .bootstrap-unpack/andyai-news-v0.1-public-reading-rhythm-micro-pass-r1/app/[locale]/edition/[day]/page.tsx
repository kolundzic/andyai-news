        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-white/70">
              Archive narrows the context. Edition becomes the calm reading destination. Navigation
              stays visible but secondary so the issue itself remains the main focus.
            </p>
          </div>
        </div>
