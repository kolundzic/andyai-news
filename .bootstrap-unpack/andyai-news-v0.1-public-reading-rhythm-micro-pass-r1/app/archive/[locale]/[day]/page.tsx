      ...
      <section className="mx-auto max-w-5xl px-6 py-14">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            <div className="text-xs uppercase tracking-[0.2em] text-white/50">Reading rhythm</div>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-white/70">
              Archive-day should feel like a transition layer: enough context to orient the reader,
              but a clear invitation to continue into the edition as the final destination.
            </p>
          </div>
        </div>
