      ...
      <div className="space-y-8">
        <div className="space-y-3">
          ...
          <p className="max-w-2xl text-sm leading-7 text-neutral-600 sm:text-base">
            Browse published editions by locale and day. This archive is the clearest public entry
            point for moving from overview into a specific daily edition.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-5">
          ...
          <p className="mt-2 text-sm leading-6 text-neutral-600">
            Use the archive to choose the edition you want to read next. Once a locale and day are
            selected, the flow continues into the matching archive-day and edition reading surfaces.
          </p>
        ...
        <div className="rounded-2xl border border-dashed border-neutral-200 bg-neutral-50 p-5">
          <h2 className="text-base font-semibold text-neutral-900">Reading continuity</h2>
          <p className="mt-2 text-sm leading-6 text-neutral-600">
            Archive is the decision layer. Archive-day narrows the context. Edition becomes the
            final reading destination.
          </p>
        </div>
      </div>
    </main>
