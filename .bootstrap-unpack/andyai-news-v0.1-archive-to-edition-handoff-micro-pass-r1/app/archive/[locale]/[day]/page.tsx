    ...
    <main className="min-h-screen bg-[#081b33] text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-14">
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-5">
          <div className="text-xs uppercase tracking-[0.2em] text-white/50">Archive to edition handoff</div>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-white/70">
            The next action from this page should feel obvious: once the locale and day are right,
            the reader continues straight into the matching edition page for the full issue.
          </p>
